...
function add() {
	...
	greencar_imgt.onload=uploadgreencar;
...
function uploadgreencar() {
	ctx.drawImage(greencar_imgt,greencar_x,greencar_y,greencar_width,greencar_height);	
}
...
function up()
{
	if(greencar_y >=0)
	{
		...
		console.log("y= "+greencar_y+"x= "+greencar_x);
		uploadBackground();
		uploadgreencar();
	}
}
